...
export function WalletProfilePage({ address }) {
  ...
  const startEdit = () => { setDraft({ displayName: '', bio: '', mood: '', accent: '#00e9a0', links: {}, top8: [], ...(data?.profile || {}) }); setEdit(true); };
  ...
  return <div className="wallet-profile-page" style={{ '--wp-accent': accent }} data-testid="wallet-profile-page">
