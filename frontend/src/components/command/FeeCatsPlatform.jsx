...
function CreateCat({ onCreated, onCancel, preset }) {
  const [step, setStep] = useState(2);
  const [form, setForm] = useState({ name: '', handle: '', avatar: 0, brain: 'rules', strategy: 'trend', instructions: '', startingBalanceSol: '10', maxPositionSol: preset?.maxPositionSol || '0.5', dailyBuyLimitSol: '2', maxDailyLossSol: '0.5', thinkEvery: '15 min', bio: '', xHandle: '', allowlist: '', blocklist: '', walletMode: 'paper', coinPlan: 'later' });
